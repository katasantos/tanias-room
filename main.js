...
glftLoader.load('./public/addieroom_v2.glb', (gltfScene) => {
...
const texture = textureLoader.load('./public/seulgi1.jpg'); // Replace 'path/to/your/image.jpg' with the actual path to your image file
...
const texture2 = textureLoader2.load('./public/seulgi2.jpg'); // Replace 'path/to/your/image.jpg' with the actual path to your image file
// Adjust texture mapping
